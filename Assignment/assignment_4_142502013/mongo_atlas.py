...
def get_connection(atlas_uri):
    try:
        client = MongoClient(atlas_uri, maxPoolSize=50, serverSelectionTimeoutMS=5000)
...
if __name__ == "__main__":
    ...
    atlas_uri = "mongodb+srv://142502013:root@cluster0.wnsgpl4.mongodb.net/"
    client = get_connection(atlas_uri)
    if client:
